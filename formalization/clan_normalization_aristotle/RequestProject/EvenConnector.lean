...
Main file of the even-connector development (moved into the library as
`RequestProject/EvenConnector.lean`).  All statements below are the formal counterparts of the objects and
