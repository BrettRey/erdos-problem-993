...
- **Subcubic census n=35 clean; the n=34 failure is isolated so far (2026-08-26).** 11,077,270,335 subcubic trees at n=35, zero LC failures, total matching OEIS A000672. With n=33 clean (2.08e9), n=34 carrying exactly one failure, and n=35 clean, subcubic LC failures are extremely sparse rather than absent, which sharpens the open question from the refuted boolean conjecture to a density one: how does subcubic failure density grow against the general density (922 failures at n=32 over a far smaller population)? n=36 was still running at ship time.
