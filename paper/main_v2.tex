...
In every tree tested, the minimum slack over all $S \subseteq H$ is attained at $|S| = 1$, where Proposition~\ref{prop:singleton} guarantees positivity.
A proof of the full condition would settle Conjecture~A.
...
The compensation condition~\eqref{eq:whnc} provides a more direct path: Proposition~\ref{prop:singleton} settles the singleton case, and in all 931\,596 trees tested through $n = 23$, the tightest subset is always a singleton.
