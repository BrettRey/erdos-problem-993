...
For the regime-adaptive hard-step diagnostics used in the reduction framework, I also complete the $n=25$ Modal frontier scans (all $256+256$ residue shards for alpha and lambda dictionaries); the aggregated values and witness classes are reported in Appendix~\ref{app:certificates}.
