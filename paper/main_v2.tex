...
All $\dleaf \le 1$ trees tested through $n = 22$ (403\,400 trees) have log-concave independence sequences.
...
\begin{remark}
The mode-mean bound $\mathrm{mode}(I(T)) \le \lceil \mu(T) \rceil$ holds for all 205\,002 trees through $n = 18$ (zero violations), including both log-concavity-failing trees at $n = 26$ (where $\mu \approx 7.83$ and $\mathrm{mode} = 8$).
...
\begin{table}[ht]
  ...
  \begin{tabular}{l r r}
    ...
    LC ($\dleaf \le 1$ trees) & \liningnums{403\,400} trees & $\le 22$ \\
