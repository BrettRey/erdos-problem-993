...
On the computational side, I verify the conjecture exhaustively for all 1\,198\,738\,056 trees on $n \le 27$ vertices, with log-concavity and near-miss metrics through $n = 27$.
...
\begin{enumerate}
  ...
  \item Exhaustive verification for all trees on $n \le 27$ vertices, with log-concavity and near-miss metrics through $n = 27$ (Section~\ref{sec:exhaustive}).
...
\begin{table}[ht]
  ...
  \begin{tabular}{l r r r}
    ...
    \midrule
    Unimodality (exhaustive) & \liningnums{1\,198\,738\,056} trees & $\le 27$ & Conj.~\ref{conj:main} \\
    LC (exhaustive, $n \le 25$) & \liningnums{167\,879\,146} trees & $\le 25$ & \S\ref{sec:exhaustive} \\
