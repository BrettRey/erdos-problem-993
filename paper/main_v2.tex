...
For the regime-adaptive hard-step diagnostics used in the reduction framework, I also complete the $n=25$ frontier scans; aggregated values and witness classes are reported in Appendix~\ref{app:certificates}.
...
Two additional exploratory routes are being tracked but are not used in the theorem dependencies above: a degree-2 decomposition route and a DP ratio-dominance route.
Both have strong computational support (through $n=23$ and $n=22$ respectively) but remain conjectural and are retained as auxiliary programmes rather than part of the primary proof backbone.
