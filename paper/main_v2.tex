...
\begin{remark}[Mean shift approach]\label{rem:mean-shift}
  ...
  I verified $|\mu(T) - \mu(T/e)| < 0.537$ for all 3\,348\,674 edges in trees on $3 \le n \le 18$; the global maximum $|\delta\mu| \approx 0.537$ is attained by the tripod star $T(5,5,5)$ at the centre-to-bridge edge.
