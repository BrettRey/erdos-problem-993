...
Finally, the regime-adaptive hard-step frontier diagnostics now have a complete authoritative snapshot at $n=25$ (Modal dictionaries fully materialized at $256/256$ shards each).
The alpha frontier occurs at class $(2,21)$ with value $0.15739052900321043$, while the lambda frontier occurs at class $(5,18)$ with value $0.34114585595914226$, giving a gap of $-0.18375532695593183$.
Compared with the locked $n=24$ baseline ($\alpha_{\mathrm{front}}(24)=0.16161242603550297$, $\lambda_{\mathrm{front}}(24)=0.280781720999777$), this is a wider obstruction and a shifted lambda witness line.
This does not alter any proved theorem above, but it materially updates the empirical stress profile that future closure attempts must absorb.
