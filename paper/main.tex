...
\begin{itemize}
  \item An elementary proof of broom unimodality for all $s$ (especially $s < p$) that avoids the spider theorem, exploiting the closed-form independence polynomial of broom trees.
