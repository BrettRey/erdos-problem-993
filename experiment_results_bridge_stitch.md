...
- **Max Log-Concavity Ratio:** $\approx 1.222$
    - Found at $N=16$ (from components $n_1=1, n_2=15$).
    - The polynomial `[1, 3, 11, 36, 59, 46, 18, 3]` corresponds to a specific bridge construction.
